...
1. **GitHub Security Advisories** (Preferred): [Report via GitHub](https://github.com/LanikSJ/webannoyances/security/advisories/new)
2. **Email**: Send details to [security@lanik.us](mailto:security@lanik.us)
3. **Security Discussions**: Open a discussion in our [GitHub Discussions](https://github.com/LanikSJ/webannoyances/discussions/categories/security)
4. **Security Issues**: Create a [Security Advisory](https://github.com/LanikSJ/webannoyances/security/advisories/new)
    on GitHub
...
This project provides filter lists for blocking web annoyances. Security considerations include:
...
- [AdGuard Security](https://adguard.com/en/adguard-home.html)
...
- Open a discussion in our [GitHub Discussions](https://github.com/LanikSJ/webannoyances/discussions)
- Contact the maintainers through the security email above for sensitive matters

Thank you for helping keep webannoyances secure!
